...
-\\
Slides at\\
\hspace*{0.333em}\url{https://github.com/BITSS/RT2_DC_2019}}
\date{RT2, Washington DC September 2019}
...
\item
  ...
  \href{https://github.com/BITSS/RT2_DC_2019}{github.com/BITSS/RT2\_DC\_2019}
\end{itemize}
...
\begin{quote}
There are 20 in this room.
\end{quote}

\begin{quote}
Is it something like \(\frac{1}{365} \times 20=\) 0.055?
\end{quote}
...
1 - Simulate 10,000 rooms with \(n = 20\) random birthdays, and store
the results in matrix where each row represents a room.\\
2 - For each room (row) compute the number of unique birthdays.\\
3 - Compute the average number of times a room has 20 unique birthdays,
...
\item
  ...
  \(\frac{1}{365} \times N =\) 0.055
\item
  However the true probability is of \(p(n= 20) = 0.411\)
\item
  And the simulated probability is of 0.4152
\end{itemize}
