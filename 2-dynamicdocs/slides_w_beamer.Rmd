...
[github.com/BITSS/RT2_DC_2019](https://github.com/BITSS/RT2_DC_2019)
...
[![Test](../Images/RStudioCS.png)](https://pandao.github.io/editor.md/en.html)

google: `"online markdown editor"`  
...
2 - Name it, and save it as `/2-dynamicdocs/first_dd.Rmd`.   
...
## Code for the math (`/2-dynamicdocs/first_dd_solution.Rmd`)
...
2 - Save it as `/2-dynamicdocs/Figure 5-2-4.Rmd`   
...
We will go step by step using `/2-dynamicdocs/Figure 5-2-4_solutions.Rmd` as back-up.
...
## Bonus hands-on excercise #3: Stata and TIER
...
## Final Remarks & More Resources
 ...
 - One final cool example: [Ed Rubin's materials](http://edrub.in/teaching.html) for econometrics course. Example [here](https://raw.githack.com/edrubin/EC525S19/master/NotesLecture/03WhyRegression/03WhyRegression.html).
